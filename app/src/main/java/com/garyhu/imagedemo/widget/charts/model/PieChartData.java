package com.garyhu.imagedemo.widget.charts.model;

import android.graphics.Color;
import android.graphics.Typeface;

import com.garyhu.imagedemo.widget.charts.formatter.PieChartValueFormatter;
import com.garyhu.imagedemo.widget.charts.formatter.SimplePieChartValueFormatter;
...
public class PieChartData extends AbstractChartData {
     ...
     * isValueSelectionEnabled set to true {@link (boolean)}.
     */
     ...
     * should also change chart fill ration using {@link (float)}. This flag is used only
