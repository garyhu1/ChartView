 ...
 * 时间： 2016/10/24.
 */
public class NewViewWidget extends View {
    ...
    public NewViewWidget(Context context) {
        super(context, null);
        initView();
    }

    public NewViewWidget(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public NewViewWidget(Context context, AttributeSet attrs, int defStyleAttr) {
